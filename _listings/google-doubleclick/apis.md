...
- name: Google Doubleclick API Create Content Category
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/advertising/master/_listings/google-doubleclick/userprofiles-profileid-contentcategories-post.md
x-common:
