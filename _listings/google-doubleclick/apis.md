...
- name: Google Doubleclick API Insert Creative Asset
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/advertising/master/_listings/google-doubleclick/userprofiles-profileid-creativeassets-advertiserid-creativeassets-post.md
x-common:
