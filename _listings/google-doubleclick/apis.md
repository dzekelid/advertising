...
- name: Google Doubleclick API Update Proposal To Complete
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/advertising/master/_listings/google-doubleclick/proposals-proposalid-setupcomplete-post.md
x-common:
