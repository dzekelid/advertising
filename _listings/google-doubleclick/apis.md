...
- name: Google Doubleclick API Get Custom Channels
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/advertising/master/_listings/google-doubleclick/accounts-accountid-adclients-adclientid-customchannels-get.md
x-common:
