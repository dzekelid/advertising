...
- name: Google Doubleclick API Get Creative Field Values
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/advertising/master/_listings/google-doubleclick/userprofiles-profileid-creativefields-creativefieldid-creativefieldvalues-get.md
x-common:
