...
- name: Google Doubleclick API Get Floodlight Configurations
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/advertising/master/_listings/google-doubleclick/userprofiles-profileid-floodlightconfigurations-get.md
x-common:
