...
- name: Google Doubleclick API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/advertising/master/_listings/google-doubleclick/userprofiles-profileid-campaigns-campaignid-landingpages-post.md
x-common:
