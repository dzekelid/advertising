...
- name: Google Doubleclick API Update Proposal Revision Number
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/advertising/master/_listings/google-doubleclick/proposals-proposalid-revisionnumber-updateaction-patch.md
x-common:
