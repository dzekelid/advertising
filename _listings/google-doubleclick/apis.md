...
- name: Google Doubleclick API Insert Creative Field Value
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/advertising/master/_listings/google-doubleclick/userprofiles-profileid-creativefields-creativefieldid-creativefieldvalues-post.md
x-common:
