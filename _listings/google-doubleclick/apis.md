...
- name: Google Doubleclick API Get Floodlight Configuration
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/advertising/master/_listings/google-doubleclick/userprofiles-profileid-floodlightconfigurations-id-get.md
x-common:
