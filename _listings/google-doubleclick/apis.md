...
- name: Google Doubleclick API Delete Proposal Deal
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/advertising/master/_listings/google-doubleclick/proposals-proposalid-deals-delete-post.md
x-common:
