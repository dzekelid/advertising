...
- name: Google Doubleclick API Delete Dynamic Targeting Key
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/advertising/master/_listings/google-doubleclick/userprofiles-profileid-dynamictargetingkeys-objectid-delete.md
x-common:
