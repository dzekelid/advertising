...
- name: Google Doubleclick API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/advertising/master/_listings/google-doubleclick/pretargetingconfigs-accountid-configid-delete.md
x-common:
